...
public class CategoryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.bt_Java:
                ...
                createLevelsForJava();
                Intent intentJava = new Intent(com.codewithganpath.quiz_app.CategoryActivity.this,JavaLevelsActivity.class);
            ...
            case R.id.bt_Kotlin:
                ...
                Intent intentKotlin = new Intent(com.codewithganpath.quiz_app.CategoryActivity.this,KoltinLevelsActivity.class);
            ...
            case R.id.bt_Python:
                ...
                Intent intentFlutter = new Intent(com.codewithganpath.quiz_app.CategoryActivity.this,PythonLevelsActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(com.codewithganpath.quiz_app.CategoryActivity.this,MainActivity.class);
