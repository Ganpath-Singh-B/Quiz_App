    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      btPlayScreen.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              Intent intent = new Intent(com.codewithganpath.quiz_app.Result.this,MainActivity.class);
      ...
      btPlayAgain.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              ...
              Intent intent = new Intent(com.codewithganpath.quiz_app.Result.this,QuizActivity.class);
      ...
      btPlayNextLevel.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View view) {
              if (categoryValue.equals("Java")){
                  Intent intent = new Intent(com.codewithganpath.quiz_app.Result.this,JavaLevelsActivity.class);
                  intent.putExtra("Category",categoryValue);
                  startActivity(intent);
                  finish();
              }else if (categoryValue.equals("Kotlin")){
                  Intent intent = new Intent(com.codewithganpath.quiz_app.Result.this,KoltinLevelsActivity.class);
                  intent.putExtra("Category",categoryValue);
                  startActivity(intent);
                  finish();
              }else if (categoryValue.equals("Python")){
                  Intent intent = new Intent(com.codewithganpath.quiz_app.Result.this,PythonLevelsActivity.class);
                  intent.putExtra("Category",categoryValue);
                  startActivity(intent);
                  finish();
              }
